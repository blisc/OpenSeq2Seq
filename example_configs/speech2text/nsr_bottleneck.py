...
from open_seq2seq.encoders.w2l_bottleneck_encoder import Wave2LetterBottleNeckEncoder
...
base_params = {
    ...
    "encoder": Wave2LetterBottleNeckEncoder,
    "encoder_params": {
        "convnet_blocks": [
            {
            ...
            {
                "type": "conv1d", "repeat": block_repeat_1,
            ...
            {
                "type": "conv1d", "repeat": block_repeat_2,
            ...
            {
                "type": "conv1d", "repeat": block_repeat_3,
            ...
            {
                "type": "conv1d", "repeat": block_repeat_4,
            ...
            {
                "type": "conv1d", "repeat": block_repeat_5,
