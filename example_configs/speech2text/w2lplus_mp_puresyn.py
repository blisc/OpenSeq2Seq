...
train_params = {
    ...
    "data_layer_params": {
        ...
        "dataset_files": [
            ...
            "/data/speech/LibriSpeech/LibriSpeech/data_syn_1.txt",
            "/data/speech/LibriSpeech/LibriSpeech/data_syn_2.txt",
            "/data/speech/LibriSpeech/LibriSpeech/data_syn_3.txt",
        ],
        "max_duration": 16.7,
        "shuffle": True,
        "syn_ver": 2,
